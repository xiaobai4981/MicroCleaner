package com.leyou.microstorageanalyzer
...
import com.leyou.microstorageanalyzer.ads.AdManager
    ...
    class ApkDecoder(private val path: String) : Decoder {
        override suspend fun decode(): DecodeResult? {
            return kotlin.runCatching {
                ApplicationHolder.app.packageManager.getPackageArchiveInfo(path, 0)!!.applicationInfo.apply { this?.publicSourceDir = path }?.loadIcon(ApplicationHolder.app.packageManager)
            }.getOrNull()?.let {
